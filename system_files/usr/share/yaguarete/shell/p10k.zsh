# YaguareteOS — Powerlevel10k appearance, shipped as the distro default.
#
# Installed to ~/.p10k.zsh by `ujust yaguarete-setup-shell` and sourced
# from the tail of the YaguareteOS .zshrc. Regenerate at any time with
# `p10k configure`; the recipe backs up an existing file before writing.
#
# Wizard options this was generated with: nerdfont-v3 + powerline, small
# icons, rainbow, unicode, 24h time, angled separators, blurred heads,
# sharp tails, 2 lines, dotted, left frame, lightest ornaments, sparse,
# many icons, fluent, instant_prompt=verbose.
#
# nerdfont-v3 is the reason install-fonts.sh is not optional: every icon
# in this file resolves through FiraCode Nerd Font. Without it the prompt
# renders as a row of replacement boxes.

# Generated by Powerlevel10k configuration wizard on 2025-12-23 at 03:23 -03.
...
# angled separators, blurred heads, sharp tails, 2 lines, dotted, left frame,
