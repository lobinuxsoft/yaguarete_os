...
// Point the first-login wallpaper at the W1 default (yaguarete_01) using the
...
// matches the X-Plasma-DefaultFillMode in every yaguarete_* package.
applet.wallpaperPlugin = 'org.kde.image'
applet.currentConfigGroup = ["Wallpaper", "org.kde.image", "General"]
applet.writeConfig("Image", "/usr/share/wallpapers/yaguarete/yaguarete_01/")
