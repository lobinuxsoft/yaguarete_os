    ...
    items: [
      {
        ...
        answer:
          'No. Sumamos sobre Bazzite: el plugin hhd-vram para repartir RAM como memoria gráfica en APUs AMD, un Portal yafti con 77 apps y ajustes en 8 secciones (182 acciones install/update/uninstall, con la salida de cada una registrada en disco), instaladores propios para nuestras apps —Yryvu y Tatu— y recetas curadas para software de terceros como Eden, Antigravity, Claude Code o Decky Loader, el wrapper ujust yaguarete-fsr4 que autodetecta la GPU, comandos de rescate y de instalación por categoría (yaguarete-rescue, yaguarete-install-gaming, yaguarete-install-dev), versionado Aurora-style en rpm-ostree status y pipeline propio firmado con cosign.',
      },
      {
